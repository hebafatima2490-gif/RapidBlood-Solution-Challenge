      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto max-h-screen">
        ...
        <div className="max-w-4xl space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4">
                <div className="space-y-2">
                  ...
                  <Input type="number" defaultValue="15" className="bg-background/50 border-border" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Donor Timeout (min)</Label>
                  <Input type="number" defaultValue="5" className="bg-background/50 border-border" />
                </div>
              </div>
            </div>
          </Card>
          ...
          <div className="flex justify-end gap-4">
            <Button variant="ghost" className="text-white font-bold uppercase text-xs">Reset to Factory</Button>
            <Button className="bg-primary hover:bg-primary/90 text-white font-bold uppercase px-8">Save Configuration</Button>
          </div>
        </div>
      </main>
    </div>
